...
public class ProportionalTransitionSelector {
    ...
    public ProportionalTransitionSelector(java.util.Map<Class, Integer> moveCounts,
            HashMap<Class, Integer> transitionProfile, GameMap map, MoveBase move, Player player)
    ...
    private static MoveBase findMinimumSquaresSolution(java.util.Map<Class, Integer> moveCounts,
            HashMap<Class, Integer> desiredProportionsMap, GameMap map, MoveBase move, Player player)
        ...
        if (moveClass != null) {
            Constructor constructor = moveClass.getConstructor(Direction.class, int.class, GameMap.class, Player.class);
