...
public class StateAnalyser {
  ...
  private void setProfilesFromGamestate(
      GameState gameState,
      Set<Position> playerPositions,
      Set<Position> opponentPlayerPositions,
      Set<Position> outOfBoundsPositions,
  ...
  private String getStateTypeFromGamestate(
      GameState gameState,
      Set<Position> playerPositions,
      Set<Position> opponentPlayerPositions,
      Set<Position> outOfBoundsPositions,
  ...
  public void setMove(MoveBase move)
    ...
    if (move == null) {
      ...
      proportionalStateSelector =
          new ProportionalStateSelector(moveCounts, spawnProfile, map, player);
    } else {
      proportionalStateSelector = null;
      proportionalTransitionSelector =
          new ProportionalTransitionSelector(moveCounts, transitionProfile, map, move, player);
    }
  }
