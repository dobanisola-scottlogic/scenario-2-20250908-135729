...
/**
 * A definition of an area in which battles could be held, and any map-specific config that applies. Faithfully
 * represents the contents of a map file without any
 **/
public class Arena {
