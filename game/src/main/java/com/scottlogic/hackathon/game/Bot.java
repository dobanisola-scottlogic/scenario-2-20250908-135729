 ...
 * A Bot's primary function is to determine a set of {@linkplain Move Moves} to
 * make at each stage in the game.
...
public abstract class Bot {
    ...
    /**
     * Sets up any initial fields or data to be used by this bot later on in the
     * game.
     * This method is called once at the beginning of the game, before the first
     * call to {@link #makeMoves(GameState)}.
     ...
     * <p>
     * The default implementation of this method does nothing. Subclasses are free
     * to override it.
     *
    ...
    /**
     * Determines the set of moves the bot's {@linkplain Player Players} should make
     * in response to the given state.
     ...
     * </ul>
     * If any of these criteria are not met, then this bot may be disqualified from
     * the game,
     * forfeiting it to other contestants.
     * <p>
     * The list <em>may</em> be empty, in which case all of this bot's Players will
     * remain stationary.
     *
