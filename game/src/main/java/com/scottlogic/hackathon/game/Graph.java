...
class Graph {
  ...
  /**
   * Finds (one of) the shortest route between the two given {@linkplain Position positions} on the
   * {@linkplain GameGeometry}, avoiding any positions that match the given predicate. This method
   * uses the <a href="https://en.wikipedia.org/wiki/A*_search_algorithm">A* search algorithm</a>.
   *
